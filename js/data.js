const products = [
    ...
    { 
        ...
        range: "50km",
        brand: "osakar",
        desc: `Osakar Alpha Sport là dòng xe đạp điện mang đậm phong cách thể thao, mạnh mẽ và đầy cá tính. Với bộ tem dán thể thao nổi bật cùng khung sườn hợp kim thép chắc chắn, xe mang lại cảm giác cực kỳ vững chãi khi cầm lái. Động cơ siêu êm, chống nước tốt giúp bạn thoải mái vượt qua những đoạn đường ngập nhẹ. Xe thích hợp cho các bạn nam sinh và những người yêu thích sự năng động.`,
        specs: {
            "Kích thước xe": "1700 x 650 x 1050 mm",
            "Tốc độ tối đa": "40 km/h",
            "Quãng đường": "50 km/lần sạc",
            "Trọng lượng": "45 Kg",
            "Phanh": "Phanh cơ trước sau",
            "Động cơ": "350W - Chống nước IP67",
            "Tải trọng": "130 Kg"
        }
    },
    { 
    ...
    { 
        ...
        range: "70km",
        brand: "osakar",
        desc: `Xe đạp điện Osakar Win là biểu tượng của sự bền bỉ và hiện đại. Mặt nạ trước thiết kế sắc nét kết hợp cùng đèn pha LED sáng vượt trội, mang đến tầm nhìn cực tốt vào ban đêm. Sở hữu động cơ tiết kiệm năng lượng, xe dễ dàng lướt đi êm ái trên những đoạn đường đông đúc. Osakar Win là lựa chọn hoàn hảo cho các bạn trẻ thích sự năng động, phá cách.`,
        specs: {
            "Tốc độ tối đa": "35 - 40 km/h",
            "Quãng đường": "70 km/lần sạc",
            "Trọng lượng xe": "42 Kg",
            "Động cơ": "250W không chổi than",
            "Giảm xóc": "Thủy lực êm ái trước/sau",
            "Tải trọng": "140 Kg"
        }
    },
    { 
        ...
        range: "70km",
        brand: "tailg",
        desc: `TAILG GR55 mang phong cách thiết kế đậm chất Italy, pha trộn nét cổ điển thanh lịch và sự hiện đại tiện dụng. Với cốp xe rộng rãi, sàn để chân thoải mái, chiếc xe này vô cùng phù hợp cho các quý cô đi làm, đi dạo phố hay học sinh tới trường. Động cơ công nghệ mới siêu êm và đặc biệt tiết kiệm điện.`,
        specs: {
            "Kích thước xe": "1650 × 680 × 1020 mm",
            "Tốc độ tối đa": "40 km/h",
            "Quãng đường": "70 km/lần sạc",
            "Trọng lượng": "45 Kg",
            "Phanh": "Phanh tang trống an toàn",
            "Tải trọng": "150 Kg"
        }
    },
    { 
    ...
    { 
        ...
        range: "70km",
        brand: "tailg",
        desc: `TAILG GX30 là minh chứng cho sự tối giản nhưng không hề nhàm chán. Xe có ngoại hình tinh gọn, dễ luồn lách vào những khung giờ cao điểm. Nhờ tối ưu hóa bộ khung, xe có trọng lượng rất nhẹ nhưng vẫn đảm bảo độ cân bằng cao. Cụm đèn hậu sắc nét cùng động cơ mạnh mẽ biến GX30 thành người bạn đường đáng tin cậy.`,
        specs: {
            "Tốc độ tối đa": "35 km/h",
            "Quãng đường": "70 km/lần sạc",
            "Thời gian sạc": "6 - 8 giờ",
            "Trọng lượng": "40 Kg",
            "Động cơ": "350W mạnh mẽ",
    ...
    { 
        ...
        price: 12600000, 
        discount: 14, // Hàng mới về
        img: "assets/img/TAILGJS32.jpg", 
        battery: "Ắc quy 48V",
        range: "70km",
        brand: "tailg",
        desc: `Tailg JS32 được thiết kế riêng cho học sinh, sinh viên với giỏ xe phía trước siêu tiện lợi để đựng cặp sách, áo mưa. Xe được lắp ráp từ linh kiện nhập khẩu cao cấp, vỏ nhựa ABS bền màu chống xước. Động cơ kháng nước ưu việt giúp bạn an tâm vượt qua những vũng nước nhẹ mùa mưa.`,
        specs: {
            "Vận tốc": "35 km/h",
            "Quãng đường": "70 km",
            "Trọng lượng": "42 Kg",
            "Động cơ": "350W chống nước",
            "Tải trọng": "130 Kg",
            "Phuộc xe": "Giảm xóc lò xo kép"
        }
    },
    { 
        id: 12, 
    ...
    { 
        ...
        range: "60km",
        brand: "tailg",
        desc: `Thiết kế lấy cảm hứng từ hoạt hình ngộ nghĩnh, TAILG JY33 rất được lòng các bạn học sinh nữ. Dù vẻ ngoài dễ thương nhưng bên trong lại trang bị khung xe thép carbon cao cấp chống gỉ sét. Màn hình đồng hồ LCD chống chói giúp người lái theo dõi lượng pin và tốc độ dễ dàng.`,
        specs: {
            "Kích thước xe": "1675mm x 665mm x 1080mm",
    ...
    { 
        ...
        range: "70km",
        brand: "nijia",
        desc: `Mẫu xe thiết kế 2 yên tách rời tiện lợi cho việc chở thêm một người phía sau. Khoảng cách gầm xe cao, chống trầy xước khi leo vỉa hè. NIJIA SWIFT có cụm đèn trước dạng tròn cổ điển tích hợp bóng LED hiện đại, đem lại vẻ đẹp vượt thời gian nhưng không kém phần thực dụng.`,
        specs: {
            "Vận tốc": "40 km/h",
            "Quãng đường": "70 km/lần sạc",
            "Tải trọng": "140 kg",
    ...
    { 
        ...
        range: "70km",
        brand: "nijia",
        desc: `Phiên bản nâng cấp đặc biệt với thiết kế 3 yên, giải pháp hoàn hảo cho các bà mẹ cần đèo theo con nhỏ. Xe được trang bị thêm khung bảo vệ chắc chắn. Động cơ vận hành mượt mà, không bị giật cục khi tăng ga, đảm bảo an toàn tuyệt đối cho người lớn và trẻ em.`,
        specs: {
            "Vận tốc": "35 - 40 km/h",
            "Quãng đường": "70 km/lần sạc",
            "Động cơ": "350W chống nước",
    ...
    { 
        ...
        range: "70km",
        brand: "nijia",
        desc: `NIJIA Winter sở hữu phong cách năng động, gọn gàng với lớp sơn bóng bẩy hút mắt. Mẫu xe này trang bị động cơ bền bỉ theo năm tháng, thiết kế yên liền khối êm ái cho cảm giác thoải mái khi di chuyển đoạn đường dài.`,
        specs: {
            "Vận tốc": "40 km/h",
            "Quãng đường": "70 km",
            "Trọng lượng": "45 kg",
            "Tải trọng": "130 kg",
            "Đèn chiếu sáng": "Đèn pha Halogen/LED",
            "Phanh": "Phanh cơ"
        }
    },
    { 
        ...
        range: "70km",
        brand: "nijia",
        desc: `Phiên bản Winter S (Sport) là sự nâng cấp hoàn mỹ về hệ thống giảm xóc và ngoại hình thể thao. Tem dán cá tính, vành đúc nguyên khối chống oxy hóa. Đặc biệt, bộ điều khiển (IC) thế hệ mới giúp xe tiết kiệm điện năng hơn 10% so với thế hệ cũ.`,
        specs: {
            "Vận tốc": "45 km/h",
            "Quãng đường": "70 km",
            "Động cơ": "500W mạnh mẽ",
            "Tải trọng": "140 kg",
            "Phanh": "Phanh đĩa trước, tang trống sau",
            "Lốp xe": "Lốp không săm bám đường"
        }
    },
    { 
        id: 18, 
    ...
    { 
        ...
        range: "70km",
        brand: "babanh",
        desc: `Xe điện 3 bánh Supper là giải pháp di chuyển cực kỳ an toàn dành cho người cao tuổi hoặc người có tay lái yếu. Thiết kế 3 bánh cân bằng chống lật tuyệt đối. Xe trang bị ghế ngồi rộng rãi có tựa lưng, rổ đựng đồ lớn phía sau rất tiện lợi cho việc đi chợ, mua sắm. Đặc biệt, xe có số lùi giúp người lái xoay trở linh hoạt trong ngõ hẹp.`,
        specs: {
            "Vận tốc": "30 km/h",
            "Tải trọng": "200 kg",
            "Thời gian sạc": "8 tiếng",
            "Số tiến lùi": "Có",
            "Phanh": "Phanh tay, phanh chân an toàn",
            "Động cơ": "800W visai siêu khoẻ"
        } 
    },
    { 
        id: 26, 
        ...
        battery: "Ắc quy 24V - 12Ah",
        range: "20km",
        brand: "landien",
        desc: `Xe lăn điện 6002 là người bạn đồng hành tuyệt vời cho người khuyết tật hoặc người già yếu. Với cần gạt điều khiển thông minh 360 độ, người dùng có thể dễ dàng tiến lùi, xoay trái phải chỉ bằng một ngón tay. Khung xe hợp kim nhôm siêu nhẹ có thể gấp gọn để bỏ vào cốp ô tô. Xe tích hợp hệ thống phanh điện từ tự động dừng khi thả tay gạt.`,
        specs: {
            "Vận tốc": "6 km/h",
            "Trọng lượng xe": "35 kg",
            "Tải trọng tối đa": "120 kg",
            "Động cơ": "2 x 250W",
            "Khả năng leo dốc": "13 độ",
            "Chất liệu khung": "Hợp kim nhôm tĩnh điện"
        } 
    },
    { 
        id: 27, 
        ...
        range: "",
        brand: "sacxedien",
        desc: `Bộ sạc chính hãng được thiết kế riêng cho dòng xe Pega S. Với công nghệ sạc thông minh, tự động ngắt điện khi bình đầy, bộ sạc giúp bảo vệ ắc quy không bị phồng, kéo dài tuổi thọ cho xe. Lõi đồng nguyên chất bên trong giúp dòng điện ổn định, chống chập cháy hiệu quả.`,
        specs: {
            "Điện áp đầu vào": "220V - 50Hz",
            "Điện áp đầu ra": "72V - 32Ah",
            "Tính năng tự ngắt": "Có",
            "Chống chập cháy": "Có",
            "Dùng cho dòng xe": "Pega S, Pega eSH"
        } 
    },
    { 
        id: 28, 
        ...
        range: "",
        brand: "sacxedien",
        desc: `Sạc DK Bike chính hãng cung cấp nguồn điện ổn định cho dòng bình 48V-12Ah. Sản phẩm được bọc bởi lớp nhựa ABS chống cháy cao cấp, quạt tản nhiệt không gây tiếng ồn giúp sạc hoạt động bền bỉ, không bị quá nhiệt trong thời gian cắm sạc dài.`,
        specs: {
            "Điện áp đầu vào": "220V",
            "Điện áp đầu ra": "48V - 12Ah",
            "Quạt tản nhiệt": "Có tích hợp",
            "Tính năng an toàn": "Tự ngắt khi pin đầy",
            "Chất liệu vỏ": "Nhựa ABS chống cháy"
        } 
    },
    { 
        id: 29, 
        ...
        range: "",
        brand: "sacxedien",
        desc: `Sạc Pega chính hãng (loại nhỏ 48V-12Ah) sử dụng cho các dòng xe đạp điện truyền thống như Pega Zinger, Cap A. Khả năng nạp điện nhanh chóng, an toàn và mạch bảo vệ quá dòng tiên tiến. Cục sạc nhỏ gọn dễ dàng mang theo cốp xe.`,
        specs: {
            "Điện áp đầu vào": "AC 220V",
            "Điện áp đầu ra": "DC 48V - 12Ah",
            "Đèn báo hiệu": "Đỏ (đang sạc), Xanh (đầy)",
            "Chống rò rỉ điện": "Có",
            "Bảo hành": "12 tháng"
        } 
    },
    { 
        ...
        range: "",
        brand: "sacxedien",
        desc: `Bộ sạc xe đạp điện phổ thông thay thế, tương thích với hầu hết các dòng xe đạp điện chạy 4 bình ắc quy nhỏ (48V-12Ah) trên thị trường như Nijia, Honda, Asama. Dù là hàng giá rẻ nhưng vẫn đảm bảo tính năng tự ngắt để bảo vệ ắc quy cơ bản.`,
        specs: {
            "Điện áp vào": "220V",
            "Điện áp ra": "48V - 12A",
            "Đèn báo sạc": "Có đèn báo Đỏ/Xanh",
            "Tự ngắt": "Tự động ngắt khi đầy",
            "Tương thích": "Đa số các dòng xe điện 4 bình nhỏ"
        } 
    },
    { 
        id: 31, 
        ...
        range: "",
        brand: "sacxedien",
        desc: `Sạc xe máy điện Osakar 60V-20Ah được thiết kế chuẩn dòng cho các xe máy điện như Osakar Xmen, Nispa... Sử dụng bo mạch IC chất lượng cao, dòng điện sạch giúp kéo dài tối đa tuổi thọ bình ắc quy to. Trang bị quạt tản nhiệt lớn giữ sạc luôn mát mẻ.`,
        specs: {
            "Dòng điện ra": "60V - 20Ah",
            "Chất liệu": "Nhựa ABS siêu bền",
            "Bảo vệ ắc quy": "Mạch IC chống phồng bình",
            "Tản nhiệt": "Quạt làm mát siêu êm",
    ...
    { 
        ...
        specs: {
            "Khung xe": "Hợp kim Magie nguyên khối",
            "Động cơ": "250W không chổi than",
            "Vận tốc tối đa": "25 km/h",
            "Trọng lượng": "19.8 kg",
            "Quãng đường trợ lực": "Lên đến 130 km",
            "Bảo mật": "Khóa số mật khẩu thông minh"
        } 
    },
    { 
        id: 36, 
        ...
        specs: {
            "Khung xe": "Hợp kim nhôm siêu nhẹ",
            "Động cơ": "250W Brushless",
            "Trọng lượng xe": "17.5 kg",
            "Quãng đường trợ lực": "Lên tới 100 km",
            "Lốp xe": "20 inch",
            "Gấp gọn": "Thời gian gập 10 giây"
        } 
    },
    { 
        id: 37, 
    ...
    },
    {
        ...
        price: 9500000,
        discount: 0,
        img: "assets/img/pegahkbike-133.jpg",
        brand: "pega",
        battery: "48V - 12Ah",
...
// --- XỬ LÝ THANH TÌM KIẾM CHUNG CHO TOÀN BỘ WEB ---
        ...
        function displayResults(list) {
            if (list.length === 0) {
                ...
                const html = list.map(item => `
                    <a href="product-detail.html?id=${item.id}" class="list-group-item list-group-item-action d-flex align-items-center">
